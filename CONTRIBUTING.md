...
The Agent Toolkit is designed to enable knowledge, tool awareness and keep a common AI workflow baseline across Jung von Matt. We welcome contributions that enhance ease of use, automate away repetitive tasks and improve the DevEx.
...
- Adding powerful new skills, prompts, and workflows
